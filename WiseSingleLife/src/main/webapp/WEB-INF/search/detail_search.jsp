            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                           ...
                           <img class="d-block w-100" src="https://thumbnail9.coupangcdn.com/thumbnails/remote/230x230ex/image/vendor_inventory/97af/a28d884b77af8aac7f4be84d19293d28e81644ad16558ef453a0a79604f0.jpg?type=m510" alt="First slide"> 
                           </div>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        <h2></h2>
                        <h5></h5>
                        <p class="available-stock"><span>덴마크 바나바나 우유</span><p>
						<h4>간단 소개:</h4>
